			...
			<div class="col-md-6">
				<div class="card">
					...
					<div class="card-body">
						<form action="/insertselection" method="post">
							<div class="mb-3">
								...
								<input type="text" class="form-control" name="assigneddate" id="assigneddate"
					value="${assigneddate}" readonly>
							</div>
							<div class="mb-3">
								<label for="assignedsnack" class="form-label">Assigned Snack</label> 
								<input type="text" class="form-control" name="assigneddate" id="assignedsnack"
					value="${snackname}" readonly>
							</div>
							<div class="mb-3">
								<label for="purchasedvendor" class="form-label">Purchased Vendor</label> 
								<input type="text" class="form-control" name="purchasedvendor" id="purchasedvendor"
					value="${vendorname}" readonly>
							...
							<input type="hidden" name="dsuser" value="${userid}">
